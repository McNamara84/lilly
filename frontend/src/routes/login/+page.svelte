...
<div class="min-h-[calc(100vh-3.5rem)] flex items-center justify-center px-4 py-8 login-background">
	<div class="glass-elevated w-full max-w-[420px] p-8">
		...
		<div class="text-center mb-8">
			<h1 class="text-4xl font-bold mb-2" style="color: var(--color-brand-500);">
				LILLY
			</h1>
		...
		<form onsubmit={handleSubmit} class="space-y-4" novalidate>
			...
			<!-- Email -->
			<div>
				<label for="email" class="block text-sm font-medium mb-1.5" style="color: var(--text-secondary);">
					E-Mail
				</label>
				<input
					id="email"
			...
			<!-- Password -->
			<div>
				<label for="password" class="block text-sm font-medium mb-1.5" style="color: var(--text-secondary);">
					Passwort
				</label>
				<input
					id="password"

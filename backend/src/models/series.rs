...
pub struct Issue {
    ...
    pub cover_source_file: Option<String>,
    pub cover_source_sha1: Option<String>,
    pub cover_source_updated_at: Option<chrono::NaiveDateTime>,
    pub source_key: Option<String>,
    pub source_record_id: Option<String>,
...
mod tests {
    ...
    fn test_issue_response_from_issue() {
        let issue = Issue {
            ...
            cover_source_file: None,
            cover_source_sha1: None,
            cover_source_updated_at: None,
            source_key: Some("maddraxikon".to_string()),
        ...
        assert_eq!(resp.part_number, Some(1));
        assert_eq!(resp.part_total, Some(2));
    }
